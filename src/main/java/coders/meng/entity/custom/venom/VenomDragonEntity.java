package coders.meng.entity.custom.venom;
...
public class VenomDragonEntity extends AnimalEntity implements IAnimatable {

    private int fireballStrength = 1;


    public VenomDragonEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createAttributesVenomDragon() {
