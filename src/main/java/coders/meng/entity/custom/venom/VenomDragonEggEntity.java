...
public class VenomDragonEggEntity extends AnimalEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public int hatchingTime = this.random.nextInt(6000) + 6000;
    public VenomDragonEggEntity(EntityType<? extends AnimalEntity> entityType, World world) {
