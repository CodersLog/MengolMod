...
public class GolemDragonEntity extends AnimalEntity implements IAnimatable {

    private int fireballStrength = 1;


    public GolemDragonEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createAttributesGolemDragon() {
