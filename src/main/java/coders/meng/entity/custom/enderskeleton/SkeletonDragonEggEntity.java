...
public class SkeletonDragonEggEntity extends AnimalEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public int hatchingTime = this.random.nextInt(6000) + 6000;
    public SkeletonDragonEggEntity(EntityType<? extends AnimalEntity> entityType, World world) {
