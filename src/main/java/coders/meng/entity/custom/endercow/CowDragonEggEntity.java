...
public class CowDragonEggEntity extends AnimalEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public int hatchingTime = this.random.nextInt(6000) + 6000;
    public CowDragonEggEntity(EntityType<? extends AnimalEntity> entityType, World world) {
